...
## Visuals
- **Skybox rework** (merged from [cara-melo/Hurricane](https://github.com/cara-melo/Hurricane)) —
  reworked sky rendering with Simple Sky / Realistic Sky / Galaxy / Clouds styles and a Sky Clock
  window (in *World Graphics Settings*).
